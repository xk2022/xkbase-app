// src/app/pages/sample/v1/overview/OverviewPage.tsx
...
import SampleList from '../list/List'
...
/**
 * ===============================================================
 * OverviewPage（Sample 清單頁）
 * - 負責：查詢、列表、導向新增/編輯頁
 * - 不負責：新增/編輯表單（交給 /sample/v1/create）
 * ===============================================================
 */
  ...
  return (
    <Content>
      ...
      <AppToolbar
        title='Sample 列表'
        breadcrumbs={[
          { label: 'Sample 管理', href: '#', active: false },
