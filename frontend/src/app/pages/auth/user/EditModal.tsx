...
export function EditModal({ editModal, onClose }: EditModalProps) {
  ...
  return (
    <Content>
      <div className={`modal fade ${editModal ? 'show d-block' : ''}`} id="kt_modal_add_user" role="dialog" tabIndex={-1} aria-modal="true">
